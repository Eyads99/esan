...
export default {
  ...
  data() {
    return {
      ...
      EGX30TickerList: [  //updated 15-9-26
        "ABUK",
        "ADIB",
        "AMOC",
        "BTFH","COMI",
        "EAST",
        "HRHO","EFIH",
        "VLMRA","FWRY","SWDY","GBCO","JUFO","MASR",
        "ORAS","PHDC",
        "TMGH","ETEL",
        "EMFD","EGAL",
        "ISPH","ORHD",
      ...
      EGX70TickerList: [ //updated 15-9-26
            "MCRO", "MPCO", "AMER", "ZMID", "NCCW",
            "OIH", "MPCI", "NIPH", "SVCE", "EGCH",
            "MASR", "OFH", "OCDI", "ELEC", "PHAR",
            "ATQA", "ARAB", "SWDY", "MOED", "AIHC",
            "ASPI", "KABO", "IEEC", "SIPC", "BONY",
            "EXPA", "IDRE", "MBSC", "HDBK", "ICFC",
            "SCEM", "POUL", "TAQA", "ARCC", "DAPH",
            "AIDC", "ORWE", "MPRC", "ISMQ", "ATLC",
            "ACTF", "LCSW", "ELKA", "EHDR", "GDWA",
            "DSCW", "MTIE", "UNIP", "CSAG", "MEPA",
            "ASCM", "ELSH", "UEGC", "COSG", "GOUR",
            "PRDC", "VALU", "OBRI", "SDTI", "ISMA",
            "ENGC", "ETRS", "CIEB", "GPIM", "AMIA",
            "EGTS", "PRCL", "ZEOT", "AIFI", "CNFN"
      ],
      idxBeginYTDValues: {
        EGX30: 25501.94,
        EGX70: 5640.68,
